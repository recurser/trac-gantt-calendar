...
h2. 2010/12/16 Update

I've been in touch with the original author of this plugin, and his latest version (0.12) supports English now. 

I recommend you {{ "svn.sourceforge.jp/svnroot/shibuya-trac/plugins/ganttcalendarplugin/trunk" | ext_link: "use his svn repository" }} rather than this out-dated version :
...
More information is available at the {{ "trac-hacks.org/wiki/GanttCalendarPlugin" | ext_link: "Trac-Hacks plugin page." }}
